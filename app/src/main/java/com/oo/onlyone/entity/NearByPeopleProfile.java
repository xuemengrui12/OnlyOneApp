...
public class NearByPeopleProfile extends Entity implements Parcelable {
	...
	public static Creator<NearByPeopleProfile> getCreator() {
		return CREATOR;
	}
	...
	public static final Creator<NearByPeopleProfile> CREATOR = new Creator<NearByPeopleProfile>() {

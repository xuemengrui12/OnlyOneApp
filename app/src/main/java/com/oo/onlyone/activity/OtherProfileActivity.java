...
import com.oo.onlyone.activity.message.ChatActivity;
...
import com.oo.onlyone.view.RoundImageView;
import com.oo.onlyone.view.UserPhotosView;


public class OtherProfileActivity extends BaseActivity implements
		OnClickListener, UserPhotosView.onPagerPhotoItemClickListener {

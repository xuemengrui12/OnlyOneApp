...
import com.oo.onlyone.adapter.FeedProfileCommentsAdapter;
import com.oo.onlyone.adapter.SimpleListDialogAdapter;
...
import com.oo.onlyone.popupwindow.OtherFeedListPopupWindow;
import com.oo.onlyone.util.DateUtils;
...
public class FeedProfileActivity extends BaseActivity implements
		OnItemClickListener, HeaderLayout.onRightImageButtonClickListener,
		OtherFeedListPopupWindow.onOtherFeedListPopupItemClickListner, OnClickListener, OnTouchListener {
	...
	protected void initViews() {
		mHeaderLayout =  findViewById(R.id.feedprofile_header);
	...
	private void initHeaderView() {
		...
		if (!TextUtils.isEmpty(mPeople.getIndustry())) {

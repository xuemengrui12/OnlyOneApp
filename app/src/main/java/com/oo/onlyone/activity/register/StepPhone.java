package com.oo.onlyone.activity.register;
...
import com.oo.onlyone.dialog.WebDialog;
import com.oo.onlyone.jni.JniManager;
import com.oo.onlyone.util.TextUtils;
import com.oo.onlyone.view.HandyTextView;


public class StepPhone extends RegisterStep implements OnClickListener,
		TextWatcher, SimpleListDialog.onSimpleListItemClickListener, WebDialog.OnWebDialogErrorListener {

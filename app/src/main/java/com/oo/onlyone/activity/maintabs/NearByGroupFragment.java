...
import com.oo.onlyone.adapter.NearByGroupAdapter;
import com.oo.onlyone.base.BaseApplication;
import com.oo.onlyone.base.BaseFragment;
import com.oo.onlyone.util.JsonResolveUtils;
import com.oo.onlyone.view.MoMoRefreshExpandableList;
import com.oo.onlyone.view.MoMoRefreshListView;


public class NearByGroupFragment extends BaseFragment implements
		OnClickListener, OnItemClickListener, MoMoRefreshListView.OnRefreshListener,
		MoMoRefreshListView.OnCancelListener {

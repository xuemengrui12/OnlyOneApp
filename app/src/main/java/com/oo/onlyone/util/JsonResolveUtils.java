...
import com.oo.onlyone.entity.NearByGroups;
...
public class JsonResolveUtils {
	 ...
	 * @return
	 */
	public static boolean resolveNearbyProfile(Context context, NearByPeopleProfile profile, String uid) {
